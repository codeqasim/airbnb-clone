...
<div class="payment-section1">
                    ...
                    <ul class="checkin-details-left cheks-status">
                     ...
                     <ul class="checkin-details-right cheks-status">
                        <li>
                            ...
                            <span> <?php echo $currencySymbol."  ".$pricePerNight * $this->session->userdata('currency_r'); ?></span>
                        </li>
                         ...
                         <li>
							...
							echo $currencySymbol."  ".$commission * $this->session->userdata('currency_r');
                         ...
                         <li>
                            <label>Total:</label>
                            <span><?php
									echo $currencySymbol."  ".$product->totalAmt * $this->session->userdata('currency_r');
									?>
						</span>
                        </li>
  	...
  	<li>
			...
			<form method="post" action="site/user/booking_confirm/<?php echo $this->uri->segment(2); ?>" id="credit_card_form" ><?php } ?>
				...
				<li>
                    <span>Message</span>
                    <textarea class="hiost-mesg" name = "message" value=""  placeholder="Message your host.." required></textarea>
                </li>
...
<input type="submit" id="bookbtn" name="bookbtn" value="<?php if($instant == 'Yes'){?>PAY and BOOK <?php } else { ?>BOOK NOW<?php }?>" />
</div>

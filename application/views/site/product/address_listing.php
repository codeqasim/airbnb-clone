            	...
            	<div class="banner_signup">
                		...
                		<ul class="popup_address">
                          ...
                          <li>
                            ...
                            <input name="address" required id="address" type="text" value="<?php echo trim($street.' '.$street1);?>" class="title_overview" />
                         ...
                         <li>
                            ...
                            <input type="text" required name="post_code" id="post_code" value=""  placeholder="e.g. 94103" class="title_overview" />

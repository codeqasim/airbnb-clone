                        ...
                        <h1>Payment options 
                         ...
                         <div id="TabbedPanels1" class="TabbedPanels">
                          ...
                          <div class="payment_agree" style="padding-bottom:10px;">
                            ...
                            <label for="agrees_to_terms">I agree to the <a target="_blank" class="terms_link" href="<?php echo base_url();?>pages/privacy-policy">terms of service</a>.<span id="terms_warn"></span></label></p>  <FORM method="post" name="ePayment" 
										action="https://www.mobile88.com/ePayment/entry.asp"> 
										 
										<INPUT type="hidden" name="MerchantCode"   value="M07244"> 
										<INPUT type="hidden" name="PaymentId"  value=""> 
										<INPUT type="hidden" name="RefNo"   value="<?php echo $RefNo; ?>"> 
										<INPUT type="hidden" name="Amount"   value="1.00"> 
										<INPUT type="hidden" name="Currency"   value="MYR"> 
										<INPUT type="hidden" name="ProdDesc"   value="StayNest"> 
										<INPUT type="hidden" name="UserName"   value="John"> 
										<INPUT type="hidden" name="UserEmail"   value="jedeelooi@gmail.com"> 
										<INPUT type="hidden" name="UserContact"   value="0126500100"> 
										<INPUT type="hidden" name="Remark"   value=""> 
										<INPUT type="hidden" name="Lang"    value="UTF-8"> 
										<INPUT type="hidden" name="Signature"   value="<?php echo $signature; ?>"> 
										<INPUT type="hidden" name="ResponseURL" value="http:www.staynest.com/success.php"> 
										<INPUT type="hidden" name="BackendURL" value="http:www.staynest.com"> 
										 
										<!--<INPUT  type="submit" value="Book it using Ipay88" style="margin:10px 0 0 10px;" name="Submit" id="card" class="btn large green">-->
										</FORM>                           
                            ...
                            <div style="display:none" id="paypal_but"><input type="submit" id="paypal" style="margin:10px 0 0 10px;" onclick="paypal_form();" value="Book it using Paypal"  class="btn large green"></div>
                          </div>

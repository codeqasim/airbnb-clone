...
<p><?php if($this->lang->line('Appliesto') != '') { echo stripslashes($this->lang->line('Appliesto')); } else echo "Applies to both text messages & push notifications.";?></p>
      ...
      <label><input type="checkbox"><span><?php if($this->lang->line('Ireceivea') != '') { echo stripslashes($this->lang->line('Ireceivea')); } else echo "I receive a reservation request";?></span></label>

	...
	<div id="sidebar">
		<div id="secondary_nav">
			<ul id="sidenav" class="accordion_mnu collapsible">
				...
				<li><h6 style="margin: 10px 0;padding-left:40px;font-weight:normal;color:#0D68AF;">Managements<?php // print_r($privileges);?></h6></li>
				...
				<ul class="acitem" <?php if($currentUrl=='Commission'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
					...
					<!--<li><a href="admin/Commission/add_commission_form" <?php if($currentPage=='add_commission_form'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Add New Commisssion</a></li>-->

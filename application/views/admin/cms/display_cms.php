...
<!-- 							<th class="tip_top" title="Click to sort">
 ...
 -->							<th class="tip_top" title="Click to sort">
						...
						<tr>
							...
							<?php if( $row->seourl != "privacy-policy" && $row->seourl !="policy" && $row->seourl !=  "cancellation-policy"  ) { ?>
...
<!-- 							<td class="center">
 ...
 -->							<td class="center">
							...
							<td class="center">
							<?php 
					if( $row->seourl != "privacy-policy" && $row->seourl !="policy" && $row->seourl !=  "cancellation-policy" ) {
							if ($allPrev == '1' || in_array('2', $Pages)){
							...
							<?php }?>
							<?php if (($allPrev == '1' || in_array('3', $Pages)) && ( $row->seourl != "privacy-policy" && $row->seourl !="policy" && $row->seourl !=  "cancellation-policy" )){?>	

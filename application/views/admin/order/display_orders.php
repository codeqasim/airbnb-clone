						...
						<tr>
							...
							<td class="center">
                                ...
                                <div id="Plusclose<?php echo $row->id;?>" style="display:none;"><img src="images/details_close.png" onclick="viewcloseorders();" /></div>-->
                           		<a href="admin/order/order_review/<?php echo $row->dealCodeNumber;?>" class="tipTop" title="View Comments"><span class="action-icons c-suspend" style="cursor:pointer;"></span></a>
<?php /*$atts = array(
              'width'      => '1100',
              'height'     => '700',
              'scrollbars' => '1',

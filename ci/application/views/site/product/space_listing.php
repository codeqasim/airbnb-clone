					 ...
					 ?>
                      <div class="dashboard_apart">
                          ...
                          <label><?php echo $value->attribute_name; ?></label>
                            <div class="select">
							<select  name="home_type"  onchange="javascript:Detailview(this,<?php echo $listDetail->row()->id; ?>,'<?php if($value->attribute_seourl == 'propertytype')echo 'home_type';else if($value->attribute_seourl == 'roomtype') echo 'room_type';?>');">
							<?php

...
<label class="price"><?php echo $this->session->userdata('currency_s'); ?></label><label id="bookingsubtot">
                ...
                <div class="submit-link"><a class="booking-btn" onclick="return  BookingIt_new();" href="javascript:void(0);"><?php if($this->lang->line('book_now') != '') { echo stripslashes($this->lang->line('book_now')); } else echo "Book Now"; ?></a></div>
    ...
    <?php
      ...
      ?>
            ...
            <!--<article class="descri-section">
                ...
                <span class="left-space">Listing</span>
                    ...
                    <li>
                        ...
                        <ul class="acomdation-type">						
							...
							<li>
								...
								<span><?php echo $listingResult; ?>:</span>
...
<?php 
		...
		?>
			...
			<?php //} ?>
                ...
                <?php }?><li><a class="viwe-text" href="javascript:void(0);" onclick="productImage_Calendar()"><?php if($this->lang->line('view_calendar') != '') { echo stripslashes($this->lang->line('view_calendar')); } else echo "View Calendar";?></a></li>

		...
		for($i=0;$i<count($imgArr);$i++) {?>
		           ...
		           <li  class="item <?php if($i==0){?>active<?php }?>">
                       ...
                       <!-- <img src="<?php echo base_url().PRODUCTPATH.$imgArr[$i]['product_image']?>" alt="First slide"> -->
					    ...
					    <a href="javascript:void(0);"><img src="<?php echo base_url().PRODUCTPATH.$imgArr[$i]['product_image'];?>" data-gallery="first-gallery" alt="" id="image-gal-<?php echo $imgArr[$i]['id'];?>"/></a>
...
<!--......... .......... .......... FOR EMPTY SPACE....................-->
			 ...
			 <div class="animation-container">
              ...
              <input type="text" placeholder="dd-mm-yyyy" autocomplete="off"   class="login-popup" id="datefromCheck"  value="" />

              <?php }else{ ?>

              <input type="text" placeholder="dd-mm-yyyy" autocomplete="off" name="datefrom" readonly="readonly" id="datefrom" class="checkin ui-datepicker-target"  value="<?php if($this->session->userdata('searchFrom') != '') echo $this->session->userdata('searchFrom'); ?>" />
              ...
              <input type="text" placeholder="dd-mm-yyyy" autocomplete="off" class="login-popup" id="expiredateCheck" value="" />

              <?php }else{ ?>

                        <input type="text" placeholder="dd-mm-yyyy" name="expiredate" autocomplete="off" readonly="readonly" id="expiredate" onchange="DateBetween();" class="checkout ui-datepicker-target" value="<?php if($this->session->userdata('searchTo') != '') echo $this->session->userdata('searchTo'); ?>">
					<?php } ?>  
                     ...
                     <li>
                        ...
                        <label><?php if($this->lang->line('guests') != '') { echo stripslashes($this->lang->line('guests')); } else echo "Guest"; ?></label>
				  ...
				  if($this->session->userdata('searchGuest') == $i ) echo "selected" ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
					   <?php } ?>
...
<?php 
				...
				<article class="descri-section" id="s1">
					<div id="" class="slide" >              
						<ul>
							...
							$count = count($imgArr);
							for($i=0;$i<$count;$i++) { ?>
							<li  class="item <?php if($count == 1)echo "col-md-12";?><?php if($count == 2)echo "col-md-6";?><?php if($count > 2 && $i == 0)echo "col-md-9";?><?php if($count > 2 && $i > 0)echo "col-md-3";?>">
								<?php if($i == 8){
									?><a  href="javascript:void(0);" style="float: left; position: relative;" onclick="clickImage(<?php echo $imgArr[0]['id'];?>);"><img  style="position: relative;" src="<?php echo base_url().PRODUCTPATH.$imgArr[$i]['product_image'];?>"  alt=""/><span style="position: absolute; right: 0px; text-align: center; color: #fff; height: 100%; padding: 20px 0 0 0; background-color: rgba(0, 0, 0, 0.4);">See all <?php echo $count;?> Photos</span></a><?php
									break;
								} else {?>
									<a  href="javascript:void(0);" onclick="clickImage(<?php echo $imgArr[$i]['id'];?>);"><img  style="position: relative;" src="<?php echo base_url().PRODUCTPATH.$imgArr[$i]['product_image'];?>"  alt=""/></a>
								<?php }?>
							</li>
							<?php }?>
						</ul>
  ...
  <!--<article class="descri-section" id="s1">
				...
				{ ?> <div class="coverimg">
		          ...
		          <li class="item active" >
					...
					<a href="javascript:void(0);" >
							<img src="<?php echo base_url().PRODUCTPATH.$imgArr[$i]['product_image']?>"  alt=""/>
					</a>
		...
		for($i=0;$i<count($imgArr);$i++) { if($i==5){break;} if($i>3){$picCount="see all"+count($imgArr)+" photos";?> <div class="col-md-4 col-middle text-center text-contrast"> <div class="h5" style="position: absolute;top: 50px;z-index: 100;font-size: x-large; color: white;"><a href="javascript:void(0);">See all <?php echo $picCount;?>photos</a></div></div><?php } ?>
             
                     
				   <li  class="item  <?php if($i==0){?>active col-md-6<?php }if($i==1){?>col-md-6<?php }if($i>1){?>col-md-4<?php }?> ">
...
<div id="pre_approve_accept" style="display:block">
 ...
 <div class="top-title" style="display:none">
			 ...
			 <input type="text" placeholder="dd-mm-yyyy" id="datefromContact" class="checkout ui-datepicker-target" autocomplete="off"/> 
...
<input type="hidden" value="<?php echo $product->price; ?>" id="price" />   <input type="hidden" value="<?php echo $product->price; ?>" id="Global_Price" />    

				...
				<div class="payed-container">
					...
					<div class="over-view-details">
						...
						<div class="booknw-area">
							<INPUT type="button" onclick="pay_by_card();" value="Proceed with Payment Credit card" id="card" style="margin: 10px 0px 0px 10px; background: none repeat scroll 0 0 #ff7e00;color: #fff;padding: 13px 100px;">
...

{
    ...
    $.ajax({
			...
			$('#totals').html('<p style="color:#0193e6; margin-right:3px;">'+'Total Amount : '+ test[3] +'</p> ');

			$('#totals').show();

			

	        $('#disper').html('<p style="color:#0193e6; margin-right:3px;">'+'Amount Discount : '+ test[1] +'</p> ');
			...
			$('#disamount').html('<p style="color:#0193e6; margin-right:3px;">'+'Amount to be paid: '+ test[2] +'</p> ');

  ...
  <div class="container top-bar">
    <div class="row">
      ...
      <div class="span6 top-right-container">
        <p class="position-right"><a data-toggle="modal" href="#myModal"  class="my-btn1 gray1 create1"><i class="icon icon-plus"></i><?php if($this->lang->line('Createnewwishlist') != '') { echo stripslashes($this->lang->line('Createnewwishlist')); } else echo "Create New Wishlist"; ?></a></p>
      </div>
    </div>
  </div>  </div>
